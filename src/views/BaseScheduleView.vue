...
function updateScheduleRule(patientId, newRuleData) {
  // 創建一個全新的 schedule 物件，而不是在舊的物件上修改
  ...
  // 用全新的物件來替換整個 schedule，確保 Vue 能夠正確追蹤變化
