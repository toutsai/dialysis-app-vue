...
export class LabMedCorrelationViewComponent implements OnChanges {
  ...
  private ordersApi = ApiManager('medication_orders');
  private draftOrdersApi = ApiManager('medication_drafts');
